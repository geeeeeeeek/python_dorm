        ...
        <div style="padding-right: 16px; max-height:480px; overflow-x: hidden;overflow-y: auto;">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="寝室号" name="classification">
              ...
              <a-col span="12">
                <a-form-item label="班级" name="banji">
                  <a-input placeholder="请输入" v-model:value="modal.form.banji"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
...
const modal = reactive({
  ...
  rules: {
    ...
    banji: [{ required: true, message: '请输入', trigger: 'change' }],
    xuehao: [{ required: true, message: '请输入', trigger: 'change' }],
...
const handleOk = () => {
  myform.value
      ...
      .then(() => {
        ...
        formData.append('banji', modal.form.banji || '')
